...
const AllRooms = () => {
  ...
  return (
    ...
    Take advantage of our limited-time offers and special packages to enchance your stay 
...

   {
    roomsDummyData.map((room)=>(
        ...
        border-b border-gray-300 last:pb-30 last:border-0 w-200 h-100' >
            <img onClick={()=>{navigate(`/rooms/${room._id}`) ; scrollTo(0,0)}}
            src={room.images[0]} alt="" title='View Room Details' 
            className='h- md:w-1/2 rounded-xl shadow-lg object-cover cursor-pointer '/>
       ...
       <div className='flex flex-wrap items-center mt-3 mb-6 gap-4  '>
            {room.amenities.map((item, index )=>(
                <div className='grid'> 
                     <div key={index} className='flex   gap-6 w-40 m-2
   ...
   <div className={`flex items-center justify-between px-5 py-2.6 min-lg:border-b
