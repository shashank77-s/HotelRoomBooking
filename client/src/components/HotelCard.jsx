...
const HotelCard = ({room,index}) => {
  return (
    ...
    className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white
        text-gray-500/90 shadow-[0px_px_px_rgba(0,0,0,0.05)]' >
        <img src={room.images[0]} alt=""  />
    { index % 2 === 0 &&    <p className='px-3 py-1 absolute top-3 left-3 text-xs bg-white text-gray
        ...
        <div className='p-4 pt-5'>
            ...
            <div className='flex gap-12 mt-6'>
                ...
                <button className='px-4 py-2 text-sm font-medium border boder-gray-300
